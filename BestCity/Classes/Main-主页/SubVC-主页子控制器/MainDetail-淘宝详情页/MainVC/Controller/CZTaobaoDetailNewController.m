//
//  CZTaobaoDetailNewController.m
//  BestCity
//
//  Created by JasonBourne on 2020/3/5.
...
@implementation CZTaobaoDetailNewController
...
- (void)getSourceData
{
    ...
    //获取详情数据
    [GXNetTool GetNetWithUrl:[JPSERVER_URL stringByAppendingPathComponent:@"api/allowance/detail"] body:param header:nil response:GXResponseStyleJSON success:^(id result) {
...
- (void)imageGoodsView
{
    ...
    titlesView.couponPrice.hidden = YES;
