//
//  CZMeAnswersPublishThreeController.m
//  BestCity
//
...
#import "CZMeAnswersPublishThreeController.h"
#import "GXNetTool.h"
// 视图
...
@interface CZMeAnswersPublishThreeController () <UITableViewDelegate, UITableViewDataSource>
/** 表单 */
...
@implementation CZMeAnswersPublishThreeController
...
{
    CZMHSDQuestModel *model = self.dataSource[indexPath.row];
    CZMHSDQuestCell2 *cell = [CZMHSDQuestCell2 cellwithTableView:tableView];
    cell.model = model;
    [cell setAction:^(CZMHSDQuestCell2 * _Nonnull cell) {
