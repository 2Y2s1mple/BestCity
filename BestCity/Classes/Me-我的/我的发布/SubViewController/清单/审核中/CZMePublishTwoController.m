...
@interface CZMePublishTwoController () <UITableViewDelegate, UITableViewDataSource>
/** 表单 */
...
@implementation CZMePublishTwoController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CZMePublishOneCell *cell = [CZMePublishOneCell cellwithTableView2:tableView];
    cell.model = model;
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CZMePublishDetailController *vc = [[CZMePublishDetailController alloc] init];
