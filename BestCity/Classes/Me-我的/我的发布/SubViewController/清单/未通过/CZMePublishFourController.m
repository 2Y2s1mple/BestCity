...
@interface CZMePublishFourController () <UITableViewDelegate, UITableViewDataSource>
/** 表单 */
...
@implementation CZMePublishFourController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CZMePublishOneCell *cell = [CZMePublishOneCell cellwithTableView4:tableView];
    cell.model = model;
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    vc.trialId = model.articleId;
    vc.remarkStr = [NSString stringWithFormat:@"未通过原因：%@", model.remark];
