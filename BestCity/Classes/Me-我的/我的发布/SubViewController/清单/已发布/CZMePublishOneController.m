...
@interface CZMePublishOneController () <UITableViewDelegate, UITableViewDataSource>
/** 表单 */
...
@implementation CZMePublishOneController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CZMePublishOneCell *cell = [CZMePublishOneCell cellwithTableView1:tableView];
    cell.model = model;
    return cell;
}
