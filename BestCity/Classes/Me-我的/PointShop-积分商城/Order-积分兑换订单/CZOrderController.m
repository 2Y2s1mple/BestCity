...
- (void)viewDidLoad {
    ...
    //导航条
    CZNavigationView *navigationView = [[CZNavigationView alloc] initWithFrame:CGRectMake(0, (IsiPhoneX ? 24 : 0), SCR_WIDTH, 67) title:@"兑换记录" rightBtnTitle:nil rightBtnAction:nil ];
